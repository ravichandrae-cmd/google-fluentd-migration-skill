...
echo "   Input:  sample_legacy_configs/legacy_doc_example.conf"
...
echo "-------------------------------------------------------------------------"
echo ">>> BEFORE (sample_legacy_configs/legacy_doc_example.conf):"
cat sample_legacy_configs/legacy_doc_example.conf
echo ""
